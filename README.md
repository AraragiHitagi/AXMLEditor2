...
- [fourbrother/AXMLEditor](https://github.com/fourbrother/AXMLEditor)在遇到xml中有非ASCII字符（如中文）时，生成的xml文件有错误，导致apk无法加载。
- [AXMLEditor2](https://github.com/softice70/AXMLEditor2)针对上述问题进行了修正，并对部分不良点进行了改进。
...
## Thanks
- [fourbrother/AXMLEditor](https://github.com/fourbrother/AXMLEditor)
